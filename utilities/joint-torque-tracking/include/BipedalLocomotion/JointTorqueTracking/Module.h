...
#ifndef BIPEDAL_LOCOMOTION_UTILITIES_JOINT_TORQUE_TRACKING_MODULE_H
#define BIPEDAL_LOCOMOTION_UTILITIES_JOINT_TORQUE_TRACKING_MODULE_H
...
class Module : public yarp::os::RFModule
{
    ...
    std::vector<double> m_logDesiredJointTorque;

    double m_integral{0.0};
    double m_previousError{0.0};
    double m_torqueConstant{0.1};

    double m_kp{10.0}, m_ki{0.1}, m_kd{0.01};
