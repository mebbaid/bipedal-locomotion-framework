...
def plot_and_save(data):
    ...
    plot_2, = plot_data(ax[0], times(channel_2), channel_2, "green")

    legend = [plot_0, plot_1, plot_2]
    legend = fig.legend(legend, labels = ["Reference", "Actual", "DesiredTorque"], ncol = 3, loc = "upper center", frameon=False)
    ...
    ax[0].set_ylabel('position [rad] and Torque [Nm]', fontsize = label_font_size)
    ax[0].set_title('joint position and desired torque', fontsize = label_font_size)
