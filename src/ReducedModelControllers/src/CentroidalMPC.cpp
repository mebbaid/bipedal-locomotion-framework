...
struct CentroidalMPC::Impl
{
    ...
    casadi::Function ode()
    {
        ...
        casadi::MX thetaHat = casadi::MX::sym("theta_hat", 3);
        casadi::MX comReference = casadi::MX::sym("com_reference", 3);
        ...
        std::vector<casadi::MX> rhs{com + dcom * this->optiSettings.samplingTime,
                                    ...
                                    thetaHat + thetaHatDerivative * this->optiSettings.samplingTime};
    ...
    {
        using Sl = casadi::Slice;
        constexpr auto errorPrefix = "[CentroidalMPC::createController]";
        ...
        auto thetaHatCurrent = thetaHat(Sl(), 0);
        ...
        casadi::DM gravity = casadi::DM::zeros(3);
        gravity(2) = -BipedalLocomotion::Math::StandardAccelerationOfGravitation;
        auto u_adaptive = -2 * this->stableConstants.k1 * z2 + (this->stableConstants.k1 * this->stableConstants.k1) * z1 - gravity - thetaHatCurrent ; // assuming accelaration ref zero
        ...
        */
        ...
        for (const auto& [key, contact] : this->optiVariables.contacts)
        {
            ...
            for (const auto& corner : contact.corners)
            {
                ...
                cost += this->weights.payloadWeight * casadi::MX::sumsqr(corner.force -  gravity - 1/(8) * externalWrench);
            }
        }
