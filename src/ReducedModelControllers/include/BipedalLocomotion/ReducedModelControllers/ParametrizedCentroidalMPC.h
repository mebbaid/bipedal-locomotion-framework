...
#ifndef BIPEDAL_LOCOMOTION_REDUCE_MODEL_CONTROLLERS_PARAMETRIZED_CENTROIDAL_MPC_H
#define BIPEDAL_LOCOMOTION_REDUCE_MODEL_CONTROLLERS_PARAMETRIZED_CENTROIDAL_MPC_H
...
public:
     ...
     */
    const ParametrizedCentroidalMPCState& getOutput() const final;
    ...
    /**
     * Computes the contact stable force give a parameter
     * @parameter Vector containing the parameter
     */
    /*
    ...
    /**
     * Computes the parameter given a measurement/estimate of the force
     * @parameter Vector containing the measured or estimated force
...
#endif // BIPEDAL_LOCOMOTION_REDUCE_MODEL_CONTROLLERS_PARAMETRIZED_CENTROIDAL_MPC_H
